...
import { TrendingUp, LayoutDashboard, Zap, PlayCircle, CreditCard, LogOut, Clock, ListFilter, LineChart } from "lucide-react"
...
const navItems = [
  ...
  { href: "/dashboard/simulate", label: "Simulate", icon: LineChart },
